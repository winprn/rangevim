...
from .swin_transformer_v2 import SwinTransformerV2, create_swin_v2  # (unused; kept for potential future backbones)
from .tinyvim_adapter import TinyViMAdapter
from .metaformer_adapter import MetaFormerAdapter  # (unused; kept for potential future backbones)
...
def create_rangevit(model_cfg, use_kpconv=False):
    ...
    # [RangeViM] Only TinyViM is targeted; Swin and MetaFormer are not used.
