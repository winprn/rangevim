...
3. Point `data_root` in `config/nusc/config_nusc_tinyvim_full.yaml` to the nuScenes root directory.
...
python -m torch.distributed.launch \
    ...
    --master_port=63545 \
    --use_env \
    main.py config/kitti/main/config_tinyvim_aug.yaml \
...
python -m torch.distributed.launch \
    ...
    --master_port=63545 \
    --use_env \
    main.py config/nusc/config_nusc_tinyvim_full.yaml \
...
python -m torch.distributed.launch \
    ...
    --master_port=63545 \
    --use_env \
    main.py config/kitti/main/config_tinyvim_trainval.yaml \
    --data_root <SEMANTIC_KITTI_ROOT>/sequences/ \
    --save_path ./logs/test \
    --checkpoint <trained_model.pth> \
